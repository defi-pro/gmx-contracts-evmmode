...
contract PositionRouter is BasePositionManager {
    ...
    function setRequestKeysStartValues(uint256 _increasePositionRequestKeysStart, uint256 _decreasePositionRequestKeysStart) external onlyAdmin {
     ...
     function bla() public   returns (bool) {
        return true;
     }
    ...
    function executeDecreasePosition(bytes32 _key, address payable _executionFeeReceiver) public   returns (bool) {
